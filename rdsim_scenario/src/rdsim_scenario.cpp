...
nav2_util::CallbackReturn ScenarioManager::on_configure(const rclcpp_lifecycle::State & ) {
...
nav2_util::CallbackReturn ScenarioManager::on_activate(const rclcpp_lifecycle::State & ) {
...
nav2_util::CallbackReturn ScenarioManager::on_deactivate(const rclcpp_lifecycle::State & ) {
...
nav2_util::CallbackReturn ScenarioManager::on_cleanup(const rclcpp_lifecycle::State & ) {
...
nav2_util::CallbackReturn ScenarioManager::on_shutdown(const rclcpp_lifecycle::State & ) {
